...
class AppointmentController extends Controller
{
    ...
    public function store(AppointmentStoreRequest $request)
    {
        try {
            ...
            Mail::send('mail.appointment.create.job_seeker', ['appointment' => $appointment], function ($message) use ($appointment) {
                $message->to($appointment->jobSeeker->email)->subject('ppointment Created');
            });
            Mail::send('mail.appointment.create.consultant', ['appointment' => $appointment], function ($message) use ($appointment) {
